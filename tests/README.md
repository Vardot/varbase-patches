# Tests — `vardot/varbase-patches` (9.2.x)
...
Patched packages that Varbase 9.2 no longer ships, or that have no Drupal 11 release (`drupal/cl_block`, `drupal/ui_patterns_settings`, `drupal/lb_ux`), are left out of the test project and reported as skipped: there is nothing to patch.
