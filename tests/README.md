# Tests — `vardot/varbase-patches` (9.1.x)
...
Patched packages that Varbase 9.1 no longer ships (`drupal/ui_patterns_settings`, `drupal/lb_ux`) are left out of the test project and reported as skipped: there is nothing to patch.
