# Tests — `vardot/varbase-patches` (10.1.x)
...
Patched packages that have no Drupal 11 release (`drupal/cl_block`, `drupal/cl_server`) are left out of the test project and reported as skipped: there is nothing to patch.
