# Varbase Patches — Documentation (branch `9.1.x`)
...
- **Branch:** `9.1.x`
- **Drupal core:** `~10.6.0`
- **Use with:** Varbase `~9.1.0`
- **Recommended require:** `"vardot/varbase-patches": "~9.1.0"`
- **External docs:** <https://docs.varbase.vardot.com/9.1.x/developers/varbase-patches>

## What it does

1. Ships a curated `extra.patches` list (issue / MR diffs vetted by Vardot) for Drupal core and contrib modules used by Varbase 9.1.
