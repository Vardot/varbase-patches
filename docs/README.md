# Varbase Patches — Documentation (branch `10.0.x`)
...
- **Branch:** `10.0.x`
- **Drupal core:** `~10.6.0`
- **Use with:** Varbase `~10.0.0`
- **Recommended require:** `"vardot/varbase-patches": "~10.0.0"`
- **External docs:** <https://docs.varbase.vardot.com/10.0.x/developers/varbase-patches>

## What it does

1. Ships a curated `extra.patches` list (issue / MR diffs vetted by Vardot) for Drupal core and contrib modules used by Varbase 10.0.
