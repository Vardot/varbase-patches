# Varbase Patches — Documentation (branch `11.0.x`)
...
- **Branch:** `11.0.x`
- **Drupal core:** `~11.3.0`
- **Use with:** Varbase `~11.0.0`, Drupal 11
- **Recommended require:** `"vardot/varbase-patches": "~11.0.0"`
- **External docs:** <https://docs.varbase.vardot.com/11.0.x/developers/varbase-patches>

## What it does

1. Ships a curated `extra.patches` list (issue / MR diffs vetted by Vardot) for Drupal core and contrib modules used by Varbase 11.
